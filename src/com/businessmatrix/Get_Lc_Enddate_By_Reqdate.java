 ...
 */  
	...
	@Description( 
	name = "Get_Lc_Enddate_By_Reqdate",
	value = "_FUNC_(FUNDCODE string,regdate String) *—  Return the Latest Financial maturity date"
			)
public class Get_Lc_Enddate_By_Reqdate extends  GenericUDF {
	...
	if(utils==null){
		...
		String result = utils.getEnddateReqdate(p_fundcode, p_regdate);
		return result;
	}
